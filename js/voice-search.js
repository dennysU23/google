...
function voiceSearchModalOpen(){
	document.querySelector("voiceSearch").style.display = "flex";
	document.querySelector("voiceSearch").style.animation = "aparecer 0.5s forwards";
	voiceRecognition();
}


function voiceSearchModalClose(){
	document.querySelector("voiceSearch").style.animation = "desaparecer 0.25s forwards";
	setTimeout(()=>{
	    document.querySelector("voiceSearch").style.display = "none";
	},250)
}
